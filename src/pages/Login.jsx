      ...
      <div style={styles.card}>
        ...
        {step === 'mobile' ? (
          ...
          <>
            ...
            <input
              style={{ ...styles.input, width: '100%', letterSpacing: 8, fontSize: 22 }}
              type="tel"
...
const styles = {
  ...
  logo: { fontSize: 32, fontWeight: 'bold', color: '#185FA5', textAlign: 'center', margin: '0 0 4px' },
  ...
  input: { border: 'none', outline: 'none', flex: 1, height: 44, fontSize: 15, width: '100%', marginBottom: 16 },
  btn: { width: '100%', background: '#185FA5', color: '#fff', border: 'none', borderRadius: 8, height: 46, fontSize: 15, fontWeight: 600, cursor: 'pointer', marginBottom: 8 },
  linkBtn: { width: '100%', background: 'none', border: 'none', color: '#185FA5', fontSize: 14, cursor: 'pointer' },
